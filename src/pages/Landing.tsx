    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <h2 className="text-5xl md:text-6xl font-bold mb-6 text-foreground">
          ...
          <span className="block text-primary mt-2">the bullshit</span>
        </h2>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <FeatureCard
            ...
            title="Per-Slide Captions"
            description="Add captions to each slide in your carousel. Perfect for tutorials and storytelling."
          />
          <FeatureCard
            icon={<Heart className="w-8 h-8" />}
            title="Customizable Profiles"
            description="Your space, your rules. Choose templates and themes that match your style."
          />
          <FeatureCard
            icon={<FolderOpen className="w-8 h-8" />}
            title="Collections"
            description="Organize and curate posts into collections. Share your favorite finds."
          />
          <FeatureCard
            icon={<TrendingUp className="w-8 h-8" />}
            title="No Algorithm"
            description="Reverse-chronological feed. Your followers see 100% of your posts."
          />
        </div>
      </section>
